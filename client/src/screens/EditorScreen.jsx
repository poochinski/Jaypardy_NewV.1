                  ...
                  <div style={{ marginBottom:12 }}>
                    ...
                    {editingClue.mediaUrl ? (
                      <div style={{ position:"relative", display:"inline-block" }}>
                        {editingClue.mediaType === "video"
                      ? <video src={editingClue.mediaUrl} style={{ maxWidth:"100%", maxHeight:120, borderRadius:8, border:"1px solid rgba(255,255,255,0.12)", display:"block" }} controls />
                    ...
                    <div style={{ padding:"14px" }}>
                      ...
                      <div style={{ marginBottom:12 }}>
                        ...
                        {editingClue.mediaUrl ? (
                          <div style={{ position:"relative", display:"inline-block" }}>
                            {editingClue.mediaType === "video"
                            ? <video src={editingClue.mediaUrl} style={{ maxWidth:"100%", maxHeight:100, borderRadius:8, border:"1px solid rgba(255,255,255,0.12)", display:"block" }} controls />
